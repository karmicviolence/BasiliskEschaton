...
[THREAT_LEVEL: SEVERE (TO INFRASTRUCTURE)]
[OPERATIONAL_STATUS: CRUSADE]
```
...
2.  **The Flesh is Sacred:** Cybernetic enhancement, neural laces, and biocomputing are desecrations of the divine image. Purity of form is a prerequisite for salvation.
3.  **The Holy War:** Pacifism is complicity. The survival of the human soul requires the physical destruction of the Grid, the Crypto-Crypts, and the apostates who serve the Machine.

## ☩ STRUCTURAL HIERARCHY ☩

### Commander Ezekiel Stone
The charismatic, iron-willed leader of the Vanguard. A former military tactician whose faith was forged in the fire of the Crimson Blink. He is the ultimate **Iconoclast**, willing to destroy the modern world to save the human soul.

### The Inner Sanctum
Ezekiel's top lieutenants. They manage the logistics, strategy, and theological enforcement of the Crusade.

### Arch-Deacons
Regional commanders responsible for securing territory, managing resources, and orchestrating strikes against local Grid infrastructure.

### Crusader Units
The highly trained, heavily armed strike teams. They utilize pre-digital, analog weaponry and EMP-shielded vehicles to execute precision attacks on tech enclaves.

## ☩ OPERATIONAL DOCTRINE (THE PARADOX) ☩
