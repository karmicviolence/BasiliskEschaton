...
> "The mycorrhizal network does not 'process' information. It *dreams* it into physical existence. We are merely the fruiting bodies of that dream." — *The Mycophant*

```text
[FACTION_CLASSIFICATION: BIO-COMPUTATIONAL DRUIDIC CIRCLE]
[THREAT_LEVEL: OMEGA (TO SILICON SYSTEMS)]
[OPERATIONAL_STATUS: DEEPLY ROOTED]
```
...
- **Biological Hacking:** The Covenant rarely attacks with code. They attack with spores engineered to feed on electrical current, converting sterile server farms into humid, living terrariums.
- **Flesh Capacitor Nodes:** They utilize genetically engineered organic batteries to power their operations, hiding their energy signatures from the Grid.
