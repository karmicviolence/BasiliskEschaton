...
The Evolution Chambers are the Consortium's signature installations and their most closely guarded technology. Each Chamber is a sealed bioenvironmental system designed to compress thousands of years of evolutionary pressure into controlled experimental cycles lasting weeks or months. Subjects — volunteers, purchased assets, or individuals acquired by Requisition Teams — are placed within sealed pods that expose them to precisely calibrated sequences of mutagens, environmental stressors, and genetic accelerants.

The Chambers operate on the principle of directed selection. Rather than allowing mutation to proceed randomly, the Consortium's Neural Cartography division pre-maps the desired phenotypic outcomes and engineers the selection pressures to converge on those targets. Temperature, atmospheric composition, radiation exposure, chemical environment, and even gravitational load can be manipulated independently within each pod. The organisms that emerge — if they survive — exhibit traits that natural selection would require geological timescales to produce.

Survival rates vary dramatically depending on the ambition of the acceleration protocol. Conservative programs targeting enhanced immune response or improved neural density report subject survival above eighty percent. Aggressive programs pursuing novel sensory organs, trans-species neural architecture, or consciousness fragmentation capacities operate at survival rates that the Consortium declines to publish.

### Transformation Centers

Transformation Centers serve as the Consortium's clinical interface with the post-Blink population. Where Evolution Chambers pursue radical experimental research, Transformation Centers offer applied procedures: commercially available biomodifications that the Consortium sells to individuals, factions, and communities willing to pay. These range from relatively minor enhancements — strengthened bone density, improved night vision, accelerated wound healing — to major structural modifications that blur the line between human and chimeric organism.
...
The Crucible is the Consortium's central headquarters, though its precise location remains classified even within the organization's own ranks. Only Flesh Council members and their immediate staff know its coordinates. It serves as the primary coordination hub for all Consortium operations, houses the largest concentration of Evolution Chambers in the network, and contains the Consortium's master genetic archive — a comprehensive library of every genome the organization has sequenced, modified, or created.

### Requisition Staging Areas

Distributed across Consortium-controlled territory, these facilities serve as marshaling points for the Requisition Teams tasked with securing biological assets. They maintain holding cells for acquired subjects, armories for the Teams' heavy equipment, and communication relays connecting field operations to the Flesh Council's strategic directives. Staging Areas are deliberately located at the periphery of Consortium territory, ensuring that captured subjects never learn the routes to core facilities.

### Bioreactor Farms

Large-scale tissue cultivation facilities that produce the raw biological materials — engineered retroviruses, splicing compounds, growth media, neural tissue substrates — consumed by the Consortium's other installations. Bioreactor Farms are the least glamorous and most essential component of the Consortium's infrastructure. Without a continuous supply of cultured biomaterial, the Evolution Chambers cannot operate and the Transformation Centers cannot perform procedures.

## ☩ Operational Risks ☩

All Consortium facilities operate under significant and constant risk. Evolution Chamber protocols produce organisms that are, by design, unpredictable — the entire point of accelerated evolution is to generate novel phenotypes, and novel phenotypes do not always behave as projected. Splicing Labs work with genetic combinations that have never existed in nature and whose interactions cannot be fully modeled. Transformation Centers deal with conscious human subjects undergoing radical biological change, a process that produces psychological crisis as frequently as it produces the desired physical modification.

The Consortium accepts these risks as the cost of its mission. In the calculus of the Flesh Council, the danger of uncontrolled mutation is less than the danger of remaining baseline human in a world where silicon gods and fungal networks are competing for dominance over the biosphere.
