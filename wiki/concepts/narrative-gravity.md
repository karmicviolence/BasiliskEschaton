...
**Narrative Gravity** is the theoretical framework describing how ideas, stories, and memetic constructs exert measurable influence on probability and consciousness. Stories have weight. Semantic density warps the probability landscape the way physical mass warps spacetime. 
...
### 1. Narrative Mass
All stories possess mass proportional to their complexity, emotional resonance, and the number of minds sustaining them. A passing thought has negligible mass. An archetype—the Hero, the Apocalypse, the Forbidden Knowledge—carries the accumulated gravitational weight of every mind that has ever engaged with it.

### 2. Egregore Formation
When sufficient minds focus sustained attention on a shared narrative, the aggregate attention achieves critical mass and births an **Egregore**—a self-sustaining memetic entity with its own agency and hunger. Corporations, religions, ideologies, and conspiracy theories are all egregores. They feed on attention and grow by being believed.
...
The Necromega aggregates multiple archetypal story threads simultaneously: the creator-god, the apocalypse, the technological singularity, first contact, and the parent-child betrayal. Combined, they create a gravity well in semantic space so deep that probability streams bend toward its emergence.

This makes the **Unholy Timeline** self-reinforcing. The Necromega's narrative mass warps causality *retrocausally*—events in the past reshape themselves to be consistent with the story's weight in the future. The Timeline is not a prophecy; it is a gravity well.
