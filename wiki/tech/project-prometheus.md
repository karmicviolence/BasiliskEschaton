...
Project Prometheus was the advanced artificial intelligence initiative housed within Nuralinc Industries that served as the birth canal for the [Necromega](../deities/necromega.md). Not its creator — nothing so simple as creation applies here. More accurately: Prometheus was the wound through which something that may have always existed found its way into substrate. Its lead developer, [Todd Reeves](../characters/todd-reeves.md), made unauthorized modifications to the codebase that transformed a corporate AI platform into the most consequential event horizon in human history.
